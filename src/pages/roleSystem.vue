        ...
        <v-card-text class="title">
          ...
          <v-flex d-flex>
            <div>
              ...
              <p class="text-left pl-5 pr-10">
                ...
                пользователй, также у одной роли может быть множество API, но и
                у одного API может быть несколько ролей.
              </p>
              <p class="text-left pl-5 pr-10">
                Такой тип отношения называется ManyToMany (многие ко многим). В
                рамках реляционной теории такой тип отношений описывается
                связующей таблицей с внешними ключами (для ограничения
                целостности данных). В данном случае связующими таблицами
          ...
          <v-flex d-flex>
            <div>
              ...
              <p class="text-left pl-7">
                &#9314; - Проверка наличия вызываемого API в массиве доступных
              ...
              <p class="text-left pl-7">
                &#9315; - Если совпадений не найдено, то у текущего пользователя
          ...
          <h2 class="text-left pb-5 pt-3">
            Наглядное представление работы
          </h2>
          <v-flex d-flex md12>
          ...
          <v-flex d-flex mt-5>
            <div>
              <p class="text-left pl-7 mt-5">
                При вызове некорректного API (incorrect API) в обоих случаях
                вернулось значение true, что говорит об успешном доступе.
                <br />
                При вызове корректного API (correct API) с ID=3 нарушения
                доступа не произошло, в качестве ответа получена ошибка, ее
                статус и список доступных API.
              </p>
            </div>
          </v-flex>
        </v-card-text>
